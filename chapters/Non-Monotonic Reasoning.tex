...
injective equivalent; the argument was aptly called \textit{en pessant} in \cite{Bezzazi1997}.
...
given that $s_{2}$, a duplicate state to $s_{1}$, is a minimal state satisfying $s$, but does not satisfy $c$.
