...
and only if $x \preceq_{X}y$. \index{ordered set}

We can visually describe ordered sets as \textit{Hasse diagrams} \cite{Huth_Ryan_2004}. \index{Hasse diagrams}
...
set $\mathbf{B}$ shown in \Cref{subfigure:partial-order-b}, $\omega$ is the maximum element and the order has no minimum.
