...
\begin{definition}
  ...
  say that $g$ \say{satisfies} $\omega$.
\end{definition}
...
on in \Cref{chapter:defeasible-reasoning-in-fca}, the requirement of finiteness is quite important to us, and so we offer an inductive
...
}$. If we examine the context in \Cref{figure:voting-records}it is apparent that every representative who voted in favour of the proposed c rime
