...
these implications is a significantly limiting factor on which patterns may be learned. The existence of a single counter-example to an otherwise acceptible
