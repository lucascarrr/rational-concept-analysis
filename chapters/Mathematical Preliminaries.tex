...
Frequently, `preference' is used as a metonymy for an order, in this context writing \say{element $x$ is preferred to $y$} should be interpreted to mean that $\op{x,y} \in \; \preceq$, or simply $x \preceq y$. The use of the metaphor will become more apparent in \Cref{chapter:non-monotonic-reasoning}. 
