...
We can verify that $\mathcal{D}$ forms a closure system: it contains $S = {a,b,c,d}$ and remains closed under arbitrary intersections. For instance, ${a,b,d} \cap {a,c} = {a}$, which belongs to $\mathcal{D}$. The corresponding closure operator $\mathsf{d}: \mathcal{P}(S) \to \mathcal{D}$ is defined by:
...
Galois connections are connected to closure operators in a significant way:
...
\begin{tikzpicture}[
    ...
    \draw[darkblue, dotted, line width=0.8pt] (-1.2,-1.2) to[out=90,in=90] (1.2,-1.2) to[out=270,in=0] (0,-2.2) to[out=180,in=270] (-1.2,-1.2);
    \draw[darkblue, dotted,-stealth,line width=0.8pt] (0.7,-0.4) to[out=45,in=180] (3.7,1);

    \draw[darkblue, dotted, line width=0.8pt] (-1.3,0) to[out=90,in=180] (-0.5,0.3) to[out=0,in=90] (0.3,0) to[out=270,in=0] (-0.5,-0.3) to[out=180,in=270] (-1.3,0);
    \draw[darkblue, dotted, -stealth, line width=0.8pt] (-0.2,0.5) to[out=45,in=90] (5,0.4);

    \draw[darkblue, dotted, line width=0.8pt] (-1,2.3) to[out=0,in=90] (-0.7,1.5) to[out=270,in=0] (-1,0.8) to[out=180,in=270] (-1.3,1.5) to[out=90,in=180] (-1,2.3);
    \draw[darkblue, dotted, -stealth, line width=0.8pt] (-1.5,1.5) to[out=180,in=90] (-3,-0.5) to[out=270,in=180] (0,-3) to[out=0,in=180] (2,-3) to[out=0,in=270] (4,-1.3);

    \draw[darkblue, dotted, line width=0.8pt] (-2.2,0.2) to[out=45,in=135] (-1.6,-0.1) to[out=315,in=45] (-1.3,-0.7) to[out=225,in=315] (-1.9,-0.4) to[out=135, in=225] (-2.2, 0.2);
    \draw[darkblue, dotted, -stealth, line width=0.8pt] (-2.1, -0.5) to[out=270,in=180] (0,-2.6) to[out=0,in=180] (1.5, -2.6) to[out=0,in=270] (3,-0.3);
\end{tikzpicture}
...
\begin{tikzpicture}[
    ...
    \draw[red, dotted,-stealth,line width=0.8pt] (A) to[out=180,in=0] (4);
    \draw[red, dotted,-stealth,line width=0.8pt] (B) to[out=180,in=0] (7);
    \draw[red, dotted,-stealth,line width=0.8pt] (C) to[out=90,in=90] (3);
    \draw[red, dotted,-stealth,line width=0.8pt] (D) to[out=0,in=270] (0);
\end{tikzpicture}
